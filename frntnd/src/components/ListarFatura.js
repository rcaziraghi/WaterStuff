    ...
    return (
      <div className="container-fluid">
        ...
        <div className="row">
          ...
          <div className="col">
            <input type="text" className="form-control" id="numFatura" placeholder="Filtro No fat" onChange={this.filtro}/>   
          </div>
          <div className="col">
            <input type="text" className="form-control" id="ano" placeholder="Filtro Ano" onChange={this.filtro}/>   
          </div>
          <div className="col">
            <input type="text" className="form-control" id="mes" placeholder="Filtro Mês" onChange={this.filtro}/>   
          </div>
          <div className="col">
          ...
          <div className="col">
            <input type="text" className="form-control" id="createdAt" placeholder="Filtro Data" onChange={this.filtro}/>   
          </div>
        </div>
        </div>
